describe("Module ap-viewmodels - ImportFormViewModel", () => {
    let Utility: ap.utility.UtilityHelper;
    let vm: ap.viewmodels.forms.ImportFormViewModel;
    ...
    describe("Feature: constructor", () => {
        beforeEach(() => {
            vm = new ap.viewmodels.forms.ImportFormViewModel(Utility, $mdDialog, Api, $q, $timeout, $scope, ControllersManager);
        });
